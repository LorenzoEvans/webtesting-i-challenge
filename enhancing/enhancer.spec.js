...
const { sword, armor, shield, helmet, blade } = mockItems ;
...
describe('get alters item name according to enhancement value', () => {
 const actual = get(blade) ;
 const expected = "[+1] Tolstoy"
 it('Changes names for items with enhancements higher than 0.', () => {
